...
interface WordBank {
  [theme: string]: WordEntry[]
}

export class LocalWordBank {
  private zhIdioms: WordBank
  private enWords: WordBank
  ...
  private loadWordBank(filename: string): WordBank {
    try {
   ...
   */
  private createWordCardPairs(entries: WordEntry[]): WordCard[] {
